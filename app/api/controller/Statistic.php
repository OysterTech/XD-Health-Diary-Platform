...
class Statistic extends BaseController
{
	public function getLatestList()
	{
		...
		else return packApiData(404, 'Data not found', [], '查询数据失败');
	}
